...
async function request_get_messages(chat_id, offset=0) {
    var data = await fetch((window.ENV.API_URL + `/web/data/messages?chat_id=${String(chat_id)}&offset=${offset}&limit=50`), {
        method: 'GET',
