...
export function UserProfileComponent() {
    ...
    return (
        <>
            <div className="flex flex-row gap-[clamp(5px,0.5vw,10px)] rounded-[15px] px-[clamp(5px,1.5vw,30px)] py-[clamp(5px,2vh,20px)] bg-white">
                ...
                <div className="flex flex-row justify-between w-[100%]">
                    ...
                    <span className="w-fit self-center sclae-[calc(4/3)] xl:scale-[calc(8/3)] md:scale-[2] material-symbols-outlined cursor-pointer hover:text-plate-accent duration-300 transition-all ease" onClick={() => setActivityProfile(!activityProfile)}>settings</span>
                </div>
            </div>
            {
                activityProfile ? (
                    <div className="absolute z-[2] top-0 left-0 flex justify-center items-center w-screen h-screen bg-black/66">
                        <div className="flex flex-col justify-between bg-white w-[60vw] min-h-fit h-[70vh] px-[clamp(10px,2vw,40px)] py-[clamp(10px,4vh,40px)] rounded-[20px]">
                            <div className="flex flex-col">
                                ...
                                <div className="flex flex-row gap-[clamp(5px,1vw,20px)]">
                                    <div className='flex flex-col group justify-center'>
                                        ...
                                        <input className="w-[clamp(64px,13vw,256px)] h-[clamp(64px,13vw,256px)] absolute z-[2] text-transparent opacity-[0] bg-white/33 group-hover:opacity-[1] duration-500 transition-all ease cursor-pointer" onChange={(e) => {
                                        ...
                                        <div className="flex flex-row gap-[clamp(5px,2vw,40px)] justify-between">
                                            {
                                                !editingNickname ? (
                                                    <>
                                                        ...
                                                        <span className="material-symbols-outlined w-fit self-center scale-[calc(4/3)] md:scale-[2] xl:scale-[calc(8/3)] cursor-pointer" onClick={() => setEditingNickname(true)}>edit</span>
                                                    </>
                                                ) : (
                                                    <>
                                                        <input className="px-[clamp(5px,1vw,20px)] outline-[0] py-[clamp(5px,2vh,20px)] rounded-[25px] bg-plate-accent text-[clamp(0.5rem,1.25vw,1.25rem)]" ref={editNicknameRef} />
                                                        <div className="flex flex-row gap-[clamp(5px,2vw,40px)]">
                                                            <span className="material-symbols-outlined w-fit self-center scale-[calc(4/3)] md:scale-[2] xl:scale-[calc(8/3)] cursor-pointer" onClick={() => setEditingNickname(false)}>close</span>
                                                            <span className="material-symbols-outlined w-fit self-center scale-[calc(4/3)] md:scale-[2] xl:scale-[calc(8/3)] cursor-pointer" onClick={() => {
                            ...
                            <button className="bg-plate-accent rounded-[20px] px-[clamp(5px,1vw,20px)] py-[clamp(5px,2vh,20px)] w-fit self-end hover:scale-[1.1] duration-300 ease" type="button" onClick={() => {
